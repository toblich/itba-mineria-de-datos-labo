...
params <- list(
  list("tiros" = 50, "cuantil" = 0.15, "aciertos" = -1),
  list("tiros" = 50, "cuantil" = 0.15, "aciertos" = -1),
  list("tiros" = 50, "cuantil" = 0.15, "aciertos" = -1)
  # list("tiros" = 30, "cuantil" = 0.1, "aciertos" = -1)
  # list("tiros" = 22, "cuantil" = 0.11),
  # list("tiros" = 25, "cuantil" = 0.121)
  # list("tiros" = 80, "cuantil" = 0.5),
  # list("tiros" = 100, "cuantil" = 0.7)
  # list("tiros" = 70, "cuantil" = 0.4),
  # list("tiros" = 65, "cuantil" = 0.3),
  # list("tiros" = 70, "cuantil" = 0.3)
  # list("tiros" = 93, "cuantil" = 0.71)
...
historia_aprox <- data.frame(
  "jugadores" = ultimo_j,
  "tiros" = tiros,
  "tiros_accum" = tiros_accum
)
for (p in params) {
  tiros <- ultimo_j * p$tiros
  tiros_accum <- tiros_accum + tiros
...
Estrategia_Tobias <- function(experimento) {
  ...
  for (p in params) {
    ...
    corte <- ifelse(p$aciertos > 0, p$aciertos, quantile(aciertos, p$cuantil))
...
for (experimento in 1:2500) # TODO hacer 10k vueltas
{
