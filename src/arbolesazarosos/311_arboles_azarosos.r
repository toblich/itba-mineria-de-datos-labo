...
feature_fraction <- 0.5 # entreno cada árbol con solo 50% de las variables variables
...
# Aquí es donde voy acumulando, sumando, las probabilidades
...
# aquí es donde voy a graficar los arboles
# pdf("./labo/exp/KA2101/arbolitos.pdf", paper = "a4r")

# Genero los arboles y voy sumando la probabilidad que el árbol entrenado en 202011 asigna a cada registro de 202101
...
entrega <- as.data.table(list(
  ...
  "Predicted" = as.numeric(probabilidad_ensemble > 1 / 60)
)) # genero la salida
