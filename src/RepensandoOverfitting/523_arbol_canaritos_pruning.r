...
wd <- "/Users/tlichtig/Desktop/ITBA/2-mineria-de-datos/labo"
setwd(wd) # establezco la carpeta donde voy a trabajar
...
setwd(paste(c(wd, "labo/exp/KA5230"), collapse = "/"))

# grabo la salida para Kaggle
fwrite(entrega,
        file = "stopping_at_canaritos_hip.csv",
        sep = ","
)


# imprimo el arbol original
pdf(file = "arbol_libre_hip.pdf", width = 80, height = 10)
prp(modelo_original, extra = 101, digits = 5, branch = 1, type = 4, varlen = 0, faclen = 0)
dev.off()


# imprimo el arbol pruneado por canaritos
pdf(file = "stopping_at_canaritos_hip.pdf", width = 20, height = 4)
