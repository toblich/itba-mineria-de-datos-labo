...
# Defino la  Optimización Bayesiana
...
#------------------------------------------------------------------------------
# esta función solo puede recibir los parámetros que se están optimizando
...
setwd("/Users/tlichtig/Desktop/ITBA/2-mineria-de-datos/labo/labo/exp/HT3210") # Establezco el Working Directory DEL EXPERIMENTO
