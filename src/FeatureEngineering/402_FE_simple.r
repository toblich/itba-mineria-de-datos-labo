...
# ya sea basados en la teoría económica  o en el salvaje empiricismo
# "No es que la nueva variable creada, que funciona, no tenga sentido, lo que sucede es que yo estoy siendo
# capaz de encontrárselo en este momento"
...
EnriquecerDataset <- function(dataset, arch_destino) {
  ...
  # creo un ctr_quarter que tenga en cuenta cuando los clientes hace 3 menos meses que están
  ...
  # válvula de seguridad para evitar valores infinitos
  ...
  # válvula de seguridad para evitar valores NaN  que es 0/0
  # paso los NaN a 0 , decisión polémica si las hay
  # se invita a asignar un valor razonable según la semántica del campo creado
  nans <- lapply(
    names(dataset),
